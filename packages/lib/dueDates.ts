...
export function creditDays(outages: {start: Date; end?: Date}[], windowStart: Date, windowEnd: Date): number {
  let credit = 0;
...
export function nextDue(lastDone: Date, intervalDays: number, creditedDays: number): Date {
